...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=Cj5xBLLC#_nJlmoQtb5JujdlqHdLIwYAVrbkFOori0jRDN_CiakA' : process.env.SESSION_ID,
...
AUTO_STICKER: process.env.AUTO_STICKER === undefined ? "falae" : process.env.AUTO_STICKER,
